...
# Caitlin Wong, z5477471, 21/06/2024
...
main:
	...
	syscall				#
	move	$t0, $v0		# scanf("%d", &row);

	li	$v0, 4			# syscall 4: print_string
	la	$a0, prompt_col		# 
	syscall				# printf("Enter col: ");

	li	$v0, 5			# syscall 5: read_int
	syscall				#
	move	$t1, $v0		# scanf("%d", &col);


	# TODO: add your code here!

	mul		$t3, $t0, N_COLS	# get array[row][col]
	add		$t4, $t3, $t1
	mul		$t5, $t4, 4
	la		$t6, array
	add		$t7, $t6, $t5
