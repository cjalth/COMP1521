...
# Caitlin Wong, z5477471, 9/10/2023
...
find_student_by_id__loop__body:
	...
	beq	$a0, $t4, find_student_by_id__loop__if

find_student_by_id__loop__step:
	addi	$t0, 1						#  i++;
	j	find_student_by_id__loop__cond			# }

find_student_by_id__loop__if:
	la	$t1, students
	mul	$t2, $t0, SIZEOF_STRUCT_STUDENT
	add	$t3, $t1, $t2
...
update_student_mark__body:
	...
	beqz	$v0, update_student_mark__none
	...
	sw	$t0, STRUCT_STUDENT_MARK_OFFSET($s1)

	j	update_student_mark__epilogue

update_student_mark__none:
	li	$v0, 4
...
print_report__loop__cond:
	bge	$t0, CLASS_SIZE, print_report__epilogue	# while (i < CLASS_SIZE) {
print_report__loop__body:
	...
	lw	$t3, STRUCT_STUDENT_MARK_OFFSET($t1)
	...
	# Check for UNKNOWN_MARK
	li	$t4, UNKNOWN_MARK
	beq	$t3, $t4, print_report__loop__end
